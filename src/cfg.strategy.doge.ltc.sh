...
# first placed orders
cc_sell_start_spread="2.5"
#~ cc_sell_start_spread_opposite="3"
cc_sell_start="30"
cc_sell_start_min="20"
# last palced order
cc_sell_end_spread="1.04"
#~ cc_sell_end_spread_opposite="1.03"
cc_sell_end="30"
cc_sell_end_min="20"

cc_max_open_orders="3"
...
cc_boundary_min_argval="--boundary_min_relative 0.95"
