# Firejail profile for {cc_bin_file_name_prefix}.qt.bin
# Description:
# This file is overwritten after every install/update
# Persistent local customizations
include fiejail.{cc_firejail_profile_middlename}.qt.local
...
mkdir ${HOME}/.config/{cc_gui_cfg_dir_name}
noblacklist ${HOME}/.config/{cc_gui_cfg_dir_name}
whitelist ${HOME}/.config/{cc_gui_cfg_dir_name}

noblacklist {cc_install_dir_path}/bin/{cc_bin_file_name_prefix}.qt.bin
whitelist {cc_install_dir_path}/bin/{cc_bin_file_name_prefix}.qt.bin
ignore noexec {cc_install_dir_path}/bin/{cc_bin_file_name_prefix}.qt.bin
read-only {cc_install_dir_path}/bin/{cc_bin_file_name_prefix}.qt.bin
