...
cc_price_redirections='"LBC": { "asset": "USDT", "price": 0.01}'
cc_maker_price=0
...
cc_slide_dyn_sell_step_multiplier=1.2
...
cc_additional_cfg=$(dirname "${BASH_SOURCE[0]}")/cfg.strategy.lbc.ltc.add.sh
